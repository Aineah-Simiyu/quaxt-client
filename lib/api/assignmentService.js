...
const assignmentService = {
  ...
  submitAssignment: async (assignmentId, submissionData = {}) => {
    // Debug logging
    console.log('submitAssignment - submissionData:', JSON.stringify(submissionData, null, 2));
    console.log('submitAssignment - submissionData.content:', submissionData.content);
    console.log('submitAssignment - submissionData.content.files:', submissionData.content?.files);
    ...
    console.log('submitAssignment - requestData:', JSON.stringify(requestData, null, 2));
  ...
  updateSubmission: async (submissionId, submissionData = {}) => {
    // Debug logging
    console.log('updateSubmission - submissionId:', submissionId);
    console.log('updateSubmission - submissionData:', JSON.stringify(submissionData, null, 2));
    
    const requestData = {
      content: submissionData.content || {},
    };
    
    console.log('updateSubmission - requestData:', JSON.stringify(requestData, null, 2));
